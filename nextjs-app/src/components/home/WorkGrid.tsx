...
const works: WorkItem[] = [
  ...
  { company: 'GXS Bank', shortName: 'GXS', title: 'Regional Design System — 3 Countries, 1 Source of Truth', tags: ['Design System', 'Fintech'], bgClass: 'wc-gxs', href: '/case-study/gxs', coverImage: '/images/cover-gxs.png' },
