...
const works: WorkItem[] = [
  /* Row 1 */
  { company: 'BeeBob AI', shortName: 'BeeBob', title: 'Research Ops Agent — Automating the Entire User Research Process', tags: ['Conversational AI', 'Agentic UX'], bgClass: 'wc-beebob', href: '/case-study/beebob', coverImage: '/images/cover-beebob.png' },
  ...
  { company: 'GXS Bank', shortName: 'GXS', title: 'InstaSplit — In-App Bill Split', tags: ['Fintech', 'Social UX'], bgClass: 'wc-instasplit', href: '/case-study/instasplit', coverImage: '/images/cover-gxs.png' },
